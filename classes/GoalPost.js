...
module.exports = class GoalPost {
  ...
  checkGoal(ball) {
    ...
    return Matter.Vertices.contains(this.base.parts[0].vertices, ballData) || Matter.Vertices.contains(this.leftSlant.parts[0].vertices, ballData) || Matter.Vertices.contains(this.rightSlant.parts[0].vertices, ballData);
  }
