...
module.exports = class Game {
    constructor(id, type = "game") {
        ...
        this.leftGoal = new GoalPost(10, this.gameWorld.height / 2, 600, 360, false, this.gameWorld); // Create left goal post
        this.rightGoal = new GoalPost(this.gameWorld.width-10, this.gameWorld.height / 2, 600, 360, true, this.gameWorld); // Create right goal post
